...
const required = ['MONGODB_URI', 'CLIENT_URL', 'JWT_SECRET'] as const;
...
export const env = { port: Number(process.env.PORT || 5000), nodeEnv: process.env.NODE_ENV || 'development', mongoUri: process.env.MONGODB_URI!, clientUrl: process.env.CLIENT_URL!, clientUrls, jwtSecret: process.env.JWT_SECRET! };
